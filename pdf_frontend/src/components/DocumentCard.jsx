...
export default function DocumentCard({ doc, index = 0 }) {
    const statusConfig = {
        uploaded: { color: "text-slate-400", bg: "bg-slate-500/10", label: "Uploaded" },
        processing: { color: "text-amber-400", bg: "bg-amber-500/10", label: "Processing" },
        processed: { color: "text-emerald-400", bg: "bg-emerald-500/10", label: "Ready" },
    ...
    return (
        ...
        >
            <div className="h-full flex flex-col bg-[#181b21] border border-white/5 rounded-2xl p-5 hover:border-white/10 hover:shadow-2xl transition-all duration-300">

                {/* Header */}
                <div className="flex justify-between items-start mb-6">
                    <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 rounded-lg bg-[#22262e] flex items-center justify-center text-cyan-400">
                ...
                <div className="flex-1 space-y-3 mb-6">
                    <div className="flex items-center text-xs text-slate-500 bg-[#22262e] rounded-md px-3 py-2 w-fit">
